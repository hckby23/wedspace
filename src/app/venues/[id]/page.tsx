      ...
      <section className="relative h-[70vh] overflow-hidden">
        <div className="relative w-full h-full">
          {enhancedVenue.images && enhancedVenue.images.length > 0 ? (
            ...
            <div className="w-full h-full bg-gradient-to-br from-red-50 via-amber-50 to-red-50 dark:from-red-950/20 dark:via-amber-950/20 dark:to-red-950/20 flex items-center justify-center">
          ...
          <div className="absolute top-4 right-4 flex space-x-2">
            <Button
              ...
              size="sm"
              onClick={toggleLike}
              className={`bg-white/90 dark:bg-gray-800/90 hover:bg-white dark:hover:bg-gray-800 backdrop-blur-sm ${liked ? 'text-red-600' : 'text-gray-700 dark:text-gray-300'}`}
            >
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center">
                      <div className="flex items-center bg-gradient-to-r from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 px-3 py-1 rounded-full">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Card className="p-6 border-0 bg-gradient-to-br from-red-50 to-amber-50 dark:from-red-900/10 dark:to-amber-900/10">
              ...
              <Card className="p-6 border-0 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/10 dark:to-cyan-900/10">
                <div className="flex items-center mb-3">
              ...
              <Card className="p-6 border-0 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/10 dark:to-emerald-900/10">
                <div className="flex items-center mb-3">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="overview" className="space-y-6">
                <Card className="p-6 border-0 shadow-lg bg-white dark:bg-gray-800">
                  <h3 className="text-xl font-semibold mb-4 flex items-center">
                    <Info className="w-5 h-5 mr-2 text-red-600 dark:text-red-400" />
                    About This Venue
                  </h3>
                  <div className="prose prose-gray max-w-none">
                    ...
                    {enhancedVenue.longDescription && (
                      <Button
                        ...
                        className="mt-2 p-0 h-auto text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300"
                      >
                ...
                <Card className="p-6 border-0 shadow-lg bg-white dark:bg-gray-800">
                  <h3 className="text-xl font-semibold mb-4 flex items-center">
                    <Sparkles className="w-5 h-5 mr-2 text-red-600 dark:text-red-400" />
                    Key Features
                  </h3>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {enhancedVenue.amenities.map((amenity: string, index: number) => (
                      <div key={index} className="flex items-center p-3 bg-muted/30 rounded-lg">
                        <div className="p-2 bg-gradient-to-br from-red-100 to-amber-100 dark:from-red-900/20 dark:to-amber-900/20 rounded-lg mr-3">
                          {amenity.includes('Air') && <Wifi className="w-4 h-4 text-red-600 dark:text-red-400" />}
                          {amenity.includes('Parking') && <Car className="w-4 h-4 text-red-600 dark:text-red-400" />}
                          {amenity.includes('Catering') && <Utensils className="w-4 h-4 text-red-600 dark:text-red-400" />}
                          {amenity.includes('Sound') && <Music className="w-4 h-4 text-red-600 dark:text-red-400" />}
              ...
              <TabsContent value="reviews" className="space-y-6">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <span className="ml-1 font-semibold text-gray-900 dark:text-white">{enhancedVenue.rating}</span>
                ...
                <div className="space-y-4">
                  {enhancedVenue.reviews.map((review: any) => (
                    <Card key={review.id} className="p-6 border-0 shadow-lg bg-white dark:bg-gray-800">
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center">
                          <div className="w-10 h-10 bg-gradient-to-br from-red-600 to-amber-600 rounded-full flex items-center justify-center text-white font-semibold mr-3">
              ...
              <TabsContent value="contact" className="space-y-6">
                <Card className="p-6 border-0 shadow-lg bg-white dark:bg-gray-800">
                  <h3 className="text-xl font-semibold mb-6 flex items-center">
                    <MessageCircle className="w-5 h-5 mr-2 text-red-600 dark:text-red-400" />
                    Contact Information
                  </h3>
              ...
              <Card className="p-6 border-0 shadow-lg bg-white dark:bg-gray-800">
                ...
                <div className="space-y-4">
                  ...
                  <Button 
                    ...
                    className="w-full bg-gradient-to-r from-red-600 to-amber-600 hover:from-red-700 hover:to-amber-700 text-white font-semibold"
                    size="lg"
                  >
